...
UUID=${UUID:-'a8f7fd77-c060-43fb-aae4-19b714720d41'}
VMESS_WSPATH=${VMESS_WSPATH:-'/a8f7fd77-c060-43fb-aae4-19b714720d41-vmess'}
VLESS_WSPATH=${VLESS_WSPATH:-'/a8f7fd77-c060-43fb-aae4-19b714720d41-vless'}
TROJAN_WSPATH=${TROJAN_WSPATH:-'/a8f7fd77-c060-43fb-aae4-19b714720d41-trojan'}
SS_WSPATH=${SS_WSPATH:-'/a8f7fd77-c060-43fb-aae4-19b714720d41-shadowsocks'}
